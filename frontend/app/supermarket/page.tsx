        ...
        <div className="bg-white rounded-lg shadow mb-8">
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex justify-between items-start">
              <div>
                <a
                  href={`/supermarket/shipments/${shipments[0].id}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-2xl font-bold text-gray-900 hover:text-purple-600 hover:underline inline-block"
                >
                  {shipments[0].name}
                </a>
                <p className="text-sm text-gray-600 mt-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-purple-600 hover:text-purple-800 hover:underline ml-1"
                  >
                    {shipments[0].id}
                  </a>
                </p>
